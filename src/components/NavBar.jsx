...
import logo from '../assets/img/Madadgaar logo.png';
      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto">
            ...
            <Nav.Link as={Link} to="/createReport" className={activeLink === 'report' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('report')}>Report A Case</Nav.Link>
          </Nav>
